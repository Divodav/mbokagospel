...
import { Search, Music, Mic2, Disc, Loader2, Sparkles } from "lucide-react";
            ...
            >
              {results.map((song) => (
                ...
                >
                  ...
                  <div className="px-2 py-0.5 bg-white/5 rounded-full text-[9px] font-black uppercase text-gray-500">
                    {song.genre}
                  </div>
                </div>
              ))}
